...
.controller('usuariosOnlineCtrl', function ($scope, $stateParams) {
  ...
  /*var ref = new Firebase("https://votacion-f0c45.firebaseio.com/UsuariosOnline");
...
.controller('loginCtrl', function ($scope, $stateParams, $ionicPopup, $timeout, $firebaseArray) {
